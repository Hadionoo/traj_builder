...
const double default_omega_max = 0.7; //1 rad/sec
...
public:
    ...
    void build_point_and_go_traj(geometry_msgs::PoseStamped start_pose,
            geometry_msgs::PoseStamped end_pose,
            std::vector<nav_msgs::Odometry> &vec_of_states);
    void build_braking_traj(nav_msgs::Odometry current_vel, geometry_msgs::PoseStamped start_pose, std::vector<nav_msgs::Odometry> &vec_of_states);
